...
s1 = c_spinIndices_pipi_doubleTriangle[bx%numSpinsComb][0];
s2 = c_spinIndices_pipi_doubleTriangle[bx%numSpinsComb][1];
s3 = c_spinIndices_pipi_doubleTriangle[bx%numSpinsComb][2];
s4 = c_spinIndices_pipi_doubleTriangle[bx%numSpinsComb][3];
s5 = c_spinIndices_pipi_doubleTriangle[bx%numSpinsComb][4];
s6 = c_spinIndices_pipi_doubleTriangle[bx%numSpinsComb][5];

ti = bx / numSpinsComb;

coef.x = (FLOAT) c_coef_pipi_doubleTriangle[bx%numSpinsComb][0];
coef.y = (FLOAT) c_coef_pipi_doubleTriangle[bx%numSpinsComb][1];
...
offset_Prop = tf*4*4*NSIZE*NSIZE +  s5*4*NSIZE*NSIZE + s6*NSIZE*NSIZE;
//====================================================================//
#pragma unroll
...
offset_Prop = ti*4*4*NSIZE*NSIZE +  s5*4*NSIZE*NSIZE + s4*NSIZE*NSIZE;
